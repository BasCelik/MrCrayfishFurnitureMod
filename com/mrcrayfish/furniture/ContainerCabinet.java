...
public class ContainerCabinet extends Container
{
    ...
    public ContainerCabinet(IInventory par1IInventory, IInventory par2IInventory)
    {
        ...
        for (var4 = 0; var4 < 3; ++var4)
        {
            ...
            {
                this.addSlotToContainer(new Slot(par2IInventory, var5 + var4 * 9, 8 + var5 * 18 + 36, 18 + var4 * 18));
            }
        }
