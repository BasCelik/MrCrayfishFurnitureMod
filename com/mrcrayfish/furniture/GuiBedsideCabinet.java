...
public class GuiBedsideCabinet extends GuiContainer
{
    ...
    private static final ResourceLocation gui = new ResourceLocation("textures/gui/bedsidecabinet.png");
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal(this.lowerChestInventory.getInvName()), (this.xSize / 2) - 24, 6, 4210752);
