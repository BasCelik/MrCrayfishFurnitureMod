...
{
    private ItemStack[] fridgeContents = new ItemStack[36];
    ...
    public ItemStack decrStackSize(int par1, int par2)
    {
        if (this.fridgeContents[par1] != null)
        {
            ...
            {
                var3 = this.fridgeContents[par1].splitStack(par2);
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        NBTTagList var2 = par1NBTTagCompound.getTagList("fridgeItems");
        this.fridgeContents = new ItemStack[this.getSizeInventory()];

        for (int var3 = 0; var3 < var2.tagCount(); ++var3)
        {
            NBTTagCompound var4 = (NBTTagCompound)var2.tagAt(var3);
            int var5 = var4.getByte("fridgeSlot") & 255;

            if (var5 >= 0 && var5 < this.fridgeContents.length)
            {
                this.fridgeContents[var5] = ItemStack.loadItemStackFromNBT(var4);
            }
        }
    }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            if (this.fridgeContents[var3] != null)
            {
        ...
        par1NBTTagCompound.setTag("fridgeItems", var2);
    }
     ...
     * of fridges, the adjcacent fridge check
     */
