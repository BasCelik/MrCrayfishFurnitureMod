...
public class InventoryEnvelope extends InventoryBasic 
{
	...
	public InventoryEnvelope(EntityPlayer player, ItemStack is) 
	{
		super("Envelope", false, getInventorySize(is));
	 ...
	 * 
	 * @return True when the NBT is not null and the NBT has key "Envelope"
	 *         otherwise false.
	 */
	...
	protected void readFromNBT() 
	{
		...
		NBTTagList itemList = NBTHelper.getCompoundTag(envelope, "Envelope").getTagList("Items");
