...
public class TileEntityBuildingBlock extends TileEntity implements IInventory
{
	...
	public boolean canOpen(TileEntityBuildingBlock mailBox, EntityPlayer player)
	{
		if (mailBox instanceof TileEntityBuildingBlock)
		{
