...
{
	public BlockWindmill(int par1, Material par2Material) 
	{
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		MedievalSchematics.generateWindmill(par1World, par2, par3, par4, par1World.getBlockMetadata(par2, par3, par4));
		return true;
	}
